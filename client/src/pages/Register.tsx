    ...
    <div className="max-w-5xl min-h-[70vh] mx-auto">
      <div className=" w-full mt-14">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.3, delay: 0 }}
          className="sm:w-1/2 mx-4  sm:mx-auto mt-10 bg-secondary/5 py-14 px-8 sm:px-4 rounded-lg"
        >
          <form
          ...
          <div className="flex items-center gap-2 py-4 mx-auto justify-center">
